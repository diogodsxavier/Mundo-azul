...
const animalsData = [
  ...
  { "id": 12, "name": "Peixe-Boi (Manati)", "scientificName": "Trichechus", "imageUrl": "http://farm6.staticflickr.com/5260/5514927604_bfd757f8a0_z.jpg", "habitat": "Águas costeiras quentes e rios", "funFact": "São herbívoros gentis e parentes distantes dos elefantes.", "conservationStatus": "Vulnerável" },
  { "id": 13, "name": "Lula-Gigante", "scientificName": "Architeuthis dux", "imageUrl": "http://photos.mongabay.com/07/0222giant_squid.jpg", "habitat": "Profundezas de todos os oceanos", "funFact": "Possuem os maiores olhos do reino animal, do tamanho de uma bola de basquete.", "conservationStatus": "Pouco Preocupante" },
  ...
  { "id": 18, "name": "Narval", "scientificName": "Monodon monoceros", "imageUrl": "http://www.zabaci.cz/obrazky/narval.jpg", "habitat": "Águas gélidas do Ártico", "funFact": "Seu famoso 'chifre' é um dente canino que pode crescer até 3 metros de comprimento.", "conservationStatus": "Quase Ameaçado" },
